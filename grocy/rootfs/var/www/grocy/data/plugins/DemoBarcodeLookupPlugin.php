	...
	*/
	protected function ExecuteLookup($barcode)
	{
		...
		else
		{
            ...
            $quantityUnit = FindObjectInArrayByPropertyValue($this->QuantityUnits, 'name', 'Piece');
			return [
				'name' => 'testproduct_' . RandomString(5),
				'location_id' => $this->Locations[0]->$location,
				'qu_id_purchase' => $this->QuantityUnits[0]->$quantityUnit,
				'qu_id_stock' => $this->QuantityUnits[0]->$quantityUnit,
